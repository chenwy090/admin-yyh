    ...
    <Card>
      ...
      <Form ref="addOrEditModal" :label-width="100" label-position="left">
        ...
        <Row class="padding-left-12">
          <Col span="18">
            <div>订单编号：{{dataInfo.orderNo}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>订单状态：{{dataInfo.status}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>数量：{{dataInfo.amount}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>单价：{{dataInfo.price}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>总价：{{dataInfo.totalPrice}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>实付款：{{dataInfo.realPay}} U贝抵扣：{{dataInfo.ubayDiscount}} 红包抵扣：{{dataInfo.redEnvelopeDiscount}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>渠道：{{dataInfo.source}}</div>
          </Col>
        </Row>
        ...
        <Row class="padding-left-12">
          <Col span="18">
            <div>下单时间：{{dataInfo.gmtCreate}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>付款时间：{{dataInfo.payTime}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>付款方式：{{dataInfo.payType}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>交易流水号：{{dataInfo.transactionNo}}</div>
          </Col>
        </Row>
        ...
        <Row class="padding-left-12">
          <Col span="18">
            <div>买家昵称：{{dataInfo.nickName}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>买家账号：{{dataInfo.phoneNumber}}</div>
          </Col>
        </Row>
        ...
        <Row class="padding-left-12">
          <Col span="18">
            <div>卡券编码：{{dataInfo.couponId}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>优惠券所属商户：{{dataInfo.merchantName}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>有效时间：{{dataInfo.endUseTime}}</div>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <div>售后信息：{{dataInfo.sale}}</div>
          </Col>
        </Row>
