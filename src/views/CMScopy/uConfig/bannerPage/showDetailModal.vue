    ...
    <Card>
      ...
      >
        ...
        <Row class="padding-left-12">
          <Col span="18">
            <FormItem label="活动名称">{{modal.name}}</FormItem>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <FormItem label="活动时间">{{modal.startTime}} -- {{modal.endTime}}</FormItem>
          </Col>
        </Row>
        <Row class="padding-left-12">
          <Col span="18">
            <FormItem label="状态">{{modal.status?statusList[modal.status-1].label:''}}</FormItem>
          </Col>
        </Row>
        <h3>请选择参与活动券</h3>
        <Row class="padding-left-12">
          <Col span="18">
            <FormItem label="参与活动券">
              <Button type="dashed" v-if="couponObj.length">
                <span :key="index" v-for="(item,index) in couponObj">{{item.title +'&nbsp&nbsp'}}</span>
              </Button>
            </FormItem>
          </Col>
        </Row>
