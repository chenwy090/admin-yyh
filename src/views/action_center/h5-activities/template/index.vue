		...
		watch: {
		    action: {
		      handler(val, oldVal) {
		        ...
		        this.moduleStartTime = data.startTime;
		        this.moduleEndTime = data.endTime;
		        if(type == 'query'){
		    	...
		    	if(this.formData.type == 1){
		    		this.actionYhq = {
				        ...
				        data:{
				        	...
				        	data:data,
				        	moduleStartTime:this.moduleStartTime, //模块的的开始时间结束时间
				        	moduleEndTime:this.moduleEndTime //模块的的开始时间结束时间
				        }
				    };
		    	}else{
		    		this.actionImg = {
