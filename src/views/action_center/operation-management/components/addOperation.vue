<template>
  <Card>
    ...
    <div>
      <i-form :label-width="180" v-if="operationType=='hp_window'">
        <Form-item label="小程序appid：" required>
          ...
          <Select
            v-model="operation_data.appid"
            style="width:250px"
            :disabled="operationStatus == 1?false:true"
          >
            <Option
              :value="item.appid"
        ...
        <Form-item label="弹窗类型：" required>
          <Select
            v-model="operation_data.showType"
            style="width:200px"
            :disabled="operationStatus == 3?true:false"
          >
