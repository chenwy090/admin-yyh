                ...
                <Card :bordered="false" style="margin-bottom:2px">
                    <Form ref="copponForm" label-position="right" :label-width="80" :model="copponForm" inline>
                        <FormItem label="商家名称" span="24" style="width:45%">
                            <Input v-model="copponForm.name" placeholder=" 请填写商家名称" :maxlength=20></Input>
                        </FormItem>
                        ...
                        <FormItem label="优惠卷名称" span="24" style="width:25%">
                            <Input v-model="copponForm.name" placeholder=" 请填写优惠卷名称" :maxlength=20></Input>
                        </FormItem>
                        <FormItem span="24" :label-width="1" style="float: right;">
                            <Button type="primary" class="submit" icon="ios-search" @click="search('searchForm')"
                                    style="margin-right: 5px">搜索
                            </Button>
        ...
        name: "couponModal", props: {
            ...
            return {
                ...
                tableColumns: [{
                    ...
                    title: "商家名称", key: "name", align: 'center',
                }, {
                    title: "省/市", key: "address", align: 'center',
                }, {
                    title: "优惠卷名称", key: "coupon", align: 'center',
                }, {
                    title: "有效期", key: "time", align: 'center',
                }],
                listData: [{
            ...
            this.TableLoading = false, console.log(2);
        }
    }
</script>
