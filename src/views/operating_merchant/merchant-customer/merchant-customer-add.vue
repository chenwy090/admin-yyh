            ...
            <Row  style="margin-left:15%;">
                <Row class="box">
                    ...
                    <Col span="15">
                        ...
                        <Alert v-if="this.chooseMerchant.merchantId != ''" type="success" show-icon style="width: 300px;margin-top: 15px">
                            <div>商户名称：{{this.chooseMerchant.name}}</div>
                            <div style="margin-top: 5px">商户编号：{{this.chooseMerchant.merchantId}}</div>
                        </Alert>
                        <Alert v-if="this.chooseMerchant.merchantId == ''" type="error" show-icon style="width: 300px;margin-top: 15px">
                ...
                <Row class="box">
                    <Col span="3" class="left-text"><span style="color:red">*</span>套餐</Col>
                    <Col span="5">
                        <Select v-model="add_info.serviceCode" style="width:150px" :disabled="disabled2">
                            <Option v-for="(item,index) in servicelist" :key="index" :value="item.serviceCode" >{{item.serviceName}}</Option>
                        </Select>
                    </Col>
                </Row>
                <Row class="box">
                    <Col span="3" class="left-text"><span style="color:red">*</span>推送客户数上限</Col>
                    <Col span="5">
                        <InputNumber
                ...
                <Row class="box">
                    <Col span="3" class="left-text"><span style="color:red">*</span>套餐有效期</Col>
                    <Col span="16">
                        <DatePicker
                                type="date"
                                placeholder="请选择"
                ...
                <Row class="box">
                    <Col span="3" class="left-text"><span style="color:red">*</span>应收款</Col>
                    <Col span="5">
                        <InputNumber
                                placeholder="请输入正整数，比如1"
                ...
                <Row class="box">
                    <Col span="3" class="left-text"><span style="color:red">*</span>合同号</Col>
                    <Col span="16">
                ...
                <Row class="box">
                    <Col span="3" class="left-text"><span style="color:red">*</span>签单销售</Col>
                    <Col span="16">
                ...
                <Row class="box">
                    <Col span="3" class="left-text"><span style="color:red">*</span>收费条目</Col>
                    <Col   span="2">
                ...
                <Alert v-if="compatibleList.length>0">
                    <Row  class="box" v-for="(item, index) in compatibleList">
                        ...
                        <Col  span="2">
                            <Button type="error" icon="md-trash" size='small'
                                    style="margin-left: 35px"
                                    @click="compatible_delInfo(index,item)">删除</Button>
                        </Col>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //确定选择商户
            selectMerchant(){
                if (this.chooseMerchant.merchantId && this.chooseMerchant.merchantId != ''){
                    this.merchantTabDisplay = false;
                }else {
                    this.msgErr("至少选一个商户");
                }
            ...
            getPackageInfo(){
                if (this.pageStatus != 'add' && this.packageId){
                    postRequest("/merchant/merchantPackageInfo/selectById?id=" + this.packageId).then(res => {
                        if (res.code == 200) {
                            this.add_info = {
                                serviceCode: 'merchant_customer',
                                serviceName: '精准拓客',
