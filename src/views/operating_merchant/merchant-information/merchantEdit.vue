    ...
    <Tabs :value="currentTab" @on-click="changeTab">
        <TabPane label="商户基础信息" name="info">
          <div v-if="currentTab == 'info'">
              ...
              <Alert show-icon v-if="camp_pageStatus == 'edit'" style="margin-left: 200px; width: 600px; margin-top: 10px">
                商户id :
              ...
              <Row  style="margin-left:15%;">
                <Row class="box">
                <Col span="2" class="left-text"><span style="color:red">*</span>商户名称</Col>
                <Col span="16">
                <Tooltip trigger="focus" title="提醒" content="20个汉字以内" placement="right">
                  ...
                  <Row class="box">
                      <Col span="2" class="left-text"> <span style="color:red">*</span> 商户logo</Col>
                      <Col span="3"  >
                  ...
                  <Row  class="box">
                      <Col span="2" class="left-text"> <span style="color:red">*</span> 主营品牌 </Col>
                      <Col span="4">
                          <Select v-model="mainMainBrandId" style="width:120px" placeholder="请选择主品牌" @on-change="getBrandSecendList(mainMainBrandId),edit_info.mainBrandId=''">
                              <Option
                      ...
                      <Col span="4">
                          <Select v-model="edit_info.mainBrandId" style="width:120px" placeholder="请选择二级品牌" @on-change="statusCheckChange">
                              <Option
             ...
             <Alert v-if="compatibleList.length>0">
              <Row  class="box" v-for="(item, index) in compatibleList">
                      <Col span="2" class="left-text"> </Col>

                      <Col  span="4">
                         <Select v-model="item.mainBrandId" style="width:120px" placeholder="请选择主品牌" @on-change="getBrandSecendList2(index, item.mainBrandId)">
                              <Option
                                      v-for="item in mainBrandList"
                                      :value="item.id"
                                      :key="item.id"
                       ...
                       <Col  span="2">
                        <Button type="error" icon="md-trash" size='small'  @click="compatible_delInfo(index,item)">删除</Button>
                      </Col>
                ...
                <Row  class="box">
                    <Col span="2" class="left-text"> <span style="color:red">*</span> 行业类目 </Col>
                    <Col span="4">

                        <Select v-model="mainIndustryId" style="width:120px" placeholder="请选择主行业" @on-change="getIndustrySecendList(mainIndustryId),edit_info.industryId=''">
                            <Option
             ...
             <Row  class="box">
                 <Col span="2" class="left-text"> <span style="color:red">*</span> 所在地区</Col>
                   <Col span="4" >

                    <Select v-model="edit_info.provinceCode" style="width:120px" clearable @on-change="getcitylist(edit_info.provinceCode),  edit_info.cityCode='',    edit_info.areaCode=''">
                      <Option v-for="(item,index) in provincelist" :key="index" :value="item.provinceCode">{{item.provinceName}}</Option>
                    </Select>
                   </Col>

                  <Col span="4">
                   <Select v-model="edit_info.cityCode" style="width:120px" clearable @on-change="getarealist(edit_info.cityCode)">
             ...
             <Row  class="box">
                   <Col span="2" class="left-text"> <span style="color:red">*</span> 详细地址</Col>
                   <Col span="16">
                  ...
                  <Row  class="box">
                      <Col span="2" class="left-text"> <span style="color:red">*</span> 周边商超 </Col>
                  ...
                  <Row  class="box">
                      <Col span="2" class="left-text"> <span style="color:red">*</span> 营业状态 </Col>
                      <Col span="16">
                              ...
                              <Row style="width: 600px">
                                ...
                                <Timeline>
                                  ...
                                  >
                                    ...
                                    <Card style="padding: 10px;margin-top:10px;background-color:#dcf1e4">
                                      <Row>
                                        <Col span="22">
        ...
        <TabPane label="认证信息" name="identification">
            <Card v-if="currentTab == 'identification'">
                ...
                <Row  style="margin-left:15%;">
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>营业执照名称</Col>
                        <Col span="16">
                    ...
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>统一社会信用代码</Col>
                        <Col span="16">
                    ...
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>营业执照</Col>
                        <Col span="20">
                            <div
                    ...
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>法人姓名</Col>
                        <Col span="16">
                    ...
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>法人身份证号</Col>
                        <Col span="16">
                    ...
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>身份证正面</Col>
                        <Col span="20">
                            <div
                                    style="float:left;width: 90px;height: 90px;line-height: 90px; margin-right: 10px;border: 1px dashed #dcdee2;background: #fff;"
                            ...
                            <div style="display: inline-block; margin-left: 50px;">
                                <div style="font-size:12px"><p>示例：</p></div>
                    ...
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>身份证背面</Col>
                        <Col span="20">
                            <div
                                    style="float:left;width: 90px;height: 90px;line-height: 90px; margin-right: 10px;border: 1px dashed #dcdee2;background: #fff;"
                    ...
                    <Row class="box">
                        <Col span="3" class="left-text"><span style="color:red">*</span>资金账户类型</Col>
                        <Col span="6">
                            <Select v-model="identification_info.accountType" placeholder="请选择类型" style="width: 200px" @on-change="statusCheckChange">
                    ...
                    <Alert v-if="identification_info.accountType=='bank'">
                        <Row class="box">
                            <Col span="3" class="left-text"><span style="color:red">*</span>持卡人姓名</Col>
                            <Col span="10">
                        ...
                        <Row class="box">
                            <Col span="3" class="left-text"><span style="color:red">*</span>卡号</Col>
                            <Col span="10">
                        ...
                        <Row class="box">
                            <Col span="3" class="left-text"><span style="color:red">*</span>开户行</Col>
                            <Col span="10">
                                <Tooltip trigger="focus" title="提醒" content="最多30个汉字" placement="right">
                                    <Input
                                            type="text"
                    ...
                    <Alert v-if="identification_info.accountType=='alipay'">
                        <Row class="box">
                            <Col span="3" class="left-text"><span style="color:red">*</span>支付宝账号</Col>
                            <Col span="10">
                        ...
                        <Row class="box">
                            <Col span="3" class="left-text"><span style="color:red">*</span>支付宝账号姓名</Col>
                            <Col span="10">
                    ...
                    <Alert v-if="identification_info.accountType=='weixin'">
                        <Row class="box">
                            <Col span="3" class="left-text"><span style="color:red">*</span>微信账号</Col>
                            <Col span="10">
                        ...
                        <Row class="box">
                            <Col span="3" class="left-text"><span style="color:red">*</span>微信账号姓名</Col>
                            <Col span="10">
                                <Tooltip trigger="focus" title="提醒" content="最多10个汉字" placement="right">
                                    <Input
                                            type="text"
...
export default {
  ...
  methods: {
      ...
      postRequest(
        ...
        if (res.code == 200) {
          ...
          if (res.data.merchantIdentificationInfo){
              ...
              this.bsUploadList = [{ url: res.data.merchantIdentificationInfo.businessLicenseImg }];
              this.idcFrontUploadList = [{ url: res.data.merchantIdentificationInfo.idCardImgFront }];
              this.idcBehindUploadList = [{ url: res.data.merchantIdentificationInfo.idCardImgBehind }];
          }
      ...
      identification_add(){
          ...
          postRequest(this.getUrl, this.reqParams).then(res => {
              ...
              if (res.code == 200) {
                  ...
                  postRequest("/merchant/merchantInfo/identification/add", this.identification_info).then(res => {
                      this.edit_loading = false;
                      if (res.code == 200) {
                          this.spinShow = false;
    ...
    campagin_add() {
      ...
      if (this.edit_info.provinceCode == null || this.edit_info.provinceCode == "") {
    ...
    setIMG(index, index1) {
      ...
      } else if (this.camp_pageStatus == "edit" || this.camp_pageStatus == "copy") {
        if (
          this.edit_info.merchantProfileList[index].contents[index1].imagesList
            .length > 4
        ) {
