  ...
  <div>
    <div>
      <Card :bordered="false" style="margin-bottom:2px">
        <Form inline>
          <FormItem label="团类型：" :label-width="120">
            <Select
          ...
          <FormItem style="margin-left:35px;" class="br">
            <Button type="primary" icon="ios-search" @click="startQuery"
              >搜索</Button
            >
...
sendTotop(id, isTop) {
  ...
  postRequest('/drawDaily/banner/upTotop', {id, isTop}).then(res=>{
    console.log(res, 200);
    let texts = ['取消', '']
    if (res.code == 200) {
