  ...
  <Card>
    ...
    >
      ...
      <!-- <FormItem label="省份" prop="province">
        <Input
          type="text"
          placeholder="请输入门店所在省份"
          v-model="store_data.province"
          style="width:200px"
        />
      </FormItem>
      ...
      <FormItem label="地区" prop="district">
        <Input
          type="text"
          placeholder="请输入门店所在地区"
          v-model="store_data.district"
          style="width:200px"
        />
      </FormItem>-->
...
export default {
  ...
  methods: {
    //province/city/district 老数据 进行维护  ---新数据 provinceName/cityName/districtName
    sendProvinceCode(code, name) {
      this.store_data.provinceCode = code;
      this.store_data.provinceName = name;
      this.store_data.province = name;
      this.store_data.cityCode = "";
      this.store_data.cityName = "";
      this.store_data.city = "";
      this.store_data.districtCode = "";
      this.store_data.districtName = "";
      this.store_data.district = "";
    },
    sendCityCode(code, name) {
      this.store_data.cityCode = code;
      this.store_data.cityName = name;
      this.store_data.city = name;
      this.store_data.districtCode = "";
      this.store_data.districtName = "";
      this.store_data.district = "";
    },
    sendDistrictCode(code, name) {
      this.store_data.districtCode = code;
      this.store_data.districtName = name;
      this.store_data.district = name;
    },
    // 判断当前类型
    typeTxt() {
      if (this.type == 1) {
        ...
        this.store_data = {
          ...this.storeItem,
          enabled: this.storeItem.enabled.toString(),
        };
      ...
      if (this.type == 1) {
        ...
        this.$refs["store_data"].validate(valid => {
          if (valid) {
            ...
            let formData = JSON.parse(JSON.stringify(this.store_data));
