    ...
    >
      ...
      <div>
        <Form
          ...
          :label-width="100"
        >
          <!-- /mini-user/excel/upload  名单上传 -->
          <FormItem label="文件导入：">
            <div>
              <Upload
                ref="upload"
                :headers="userToken"
                :action="`${url}/mini-user/excel/upload `"
              ...
              <Row type="flex" justify="space-between" class="code-row-bg">
                ...
                <Col span="12">
                  <!-- 名单导入模板 -->
                  <a href="javascript:;" @click="download">模板文件</a>
                </Col>
              </Row>
              <div v-if="file !== null">
...
import { getRequest, postRequest, downloadSteam, uploadFileRequest } from "@/libs/axios";
export default {
  name: "file-import",
  props: {
    id: {
  ...
  methods: {
    async download() {
      const url = "/mini-user/excel/download";
    ...
    async upload() {
      ...
      // 名单上传
      const url = "/mini-user/excel/upload";
      let fd = new FormData();
