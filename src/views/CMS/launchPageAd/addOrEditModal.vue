  ...
  >
    ...
    >
        ...
        <Col span="18">
          <FormItem label="广告图片">
            ...
            <Modal title="View Image" v-model="visible">
              <img :src="modal.imgUrl" v-if="visible" style="width: 100%" />
            </Modal>
          </FormItem>
        </Col>
      </Row>
      ...
      >
        <Col span="18">
          <FormItem label="跳转内容">
            <Input type="text" v-model="modal.contentValue" placeholder="请输入链接" style="width: 100%"></Input>
          </FormItem>
        </Col>
      </Row>
      <Row
  ...
  data() {
    return {
      ...
      contentTypeList: [
        ...
        // V1.5.6版本 删除 567 新增 领优惠
        { value: 15, label: "领优惠" },
        // { value: 5, label: "平台分红页" },
        // { value: 6, label: "领优惠页－周边券" },
        // { value: 7, label: "领优惠页－超市券" },
        { value: 10, label: "抽奖团" },
    ...
    openContent() {
      ...
      switch (this.modal.contentType) {
        case 1:
          ...
          this.$nextTick(() => {
            this.$refs["contentModal"].resetRow({
              content: this.modal.contentTitle,
              value: this.modal.contentValue
            });
          });
          break;
        case 10:
        ...
        case 11:
          ...
          this.$nextTick(() => {
            this.$refs["couponModal"].resetRow("2", {
              shopName: this.modal.contentTitle,
              shopId: this.modal.contentValue
            });
          });
          break;
        case 12:
          this.conponViewDialogModal = true;
          this.$nextTick(() => {
            this.$refs["couponModal"].resetRow("1", {
              shopName: this.modal.contentTitle,
              shopId: this.modal.contentValue
            });
          });
    ...
    ok() {
      ...
      if (this.modal.jumpFlag == 1) {
        ...
        if (
          ...
          this.modal.contentType === 3 ||
          this.modal.contentType === 4 ||
          this.modal.contentType === 10 ||
          this.modal.contentType === 11 ||
