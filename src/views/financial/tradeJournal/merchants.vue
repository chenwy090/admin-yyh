...
export default {
  ...
  methods: {
    ...
    async downLoad(){
      ...
      const {searchForm:{pageNum,pageSize,datetimerange,orderNo,merchantName,brandName,tradeNo,couponId,payType,tradeType,tradeTimeStrat,tradeTimeEnd}} = this
      let params = {
        brandName:brandName,
        couponId:couponId,
        couponType:1,
      ...
      const res = await downloadSteam('/trade/merchant/bill/transaction/flow/download',params)
      const content = res;
      ...
      if ("download" in oA) {
        ...
        // IE10+下载
        navigator.msSaveBlob(blob, '商户交易流水');
      }
    }
  },
}
